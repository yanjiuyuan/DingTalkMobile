...
Page({
	...
	getApproveList(index, keyword) {
		...
		that._getData(
			"FlowInfoNew/GetFlowStateDetail" + that.formatQueryStr(param),
			function(res) {
				that.setData({
	...
	router(row) {
		if (row.TaskId && row.FlowId) {
			...
			switch (row.FlowId) {
				...
				case 34:
					url =
						"/page/approveDetail/techonologySupply/techonologySupply";
					break;
				case 35:
				...
				case 36:
					url =
						"/page/approveDetail/intellectualProperty/intellectualProperty";
					break;
				case 67:
