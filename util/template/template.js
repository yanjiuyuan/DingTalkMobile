...
export default {
    ...
    func: {
        ...
        choosePeople(e) {
            ...
            let index = nodeId;
            let ChoseNodeId = this.data.nodeInfo.ChoseNodeId.split(",");
            ...
            if (ChoseNodeId.indexOf(`${nodeId}`) != -1) {
                let idx = ChoseNodeId.indexOf(`${nodeId}`);
                let IsSelectMoreArray = this.data.nodeInfo.IsSelectMore.split(",");
                IsMultipleSelection = IsSelectMoreArray[idx];
            }
